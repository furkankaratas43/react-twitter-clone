import {formatter} from "~/utils/formats.js";

export default function Post({post}){
    return (
        <>
        <div className="px-4 py-3 border-b gap-3 border-[color:var(--background-third)] flex relative before:absolute before:z-[-1] before:transition-colors before:inset-0 before:opacity-50 before:hover:bg-[color:var(--background-secondary)]">
            <img src={post.account.avatar} className="w-10 h-10 object-cover rounded-full" alt=""/>
                ...
                <div>
                    ...
                    <div className="flex -ml-1.5 mt-1.5">
                        <div className="flex-1 group flex items-center gap-px">
                            <div className="w-[2.172rem] h-[2.172rem] flex items-center transition-colors justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#1d9bf01a] rounded-full group-hover:text-[#1d9bf0]">
                            ...
                            <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0]">{formatter(post.stats.comments)}</span>
                        </div>
                        <div className="flex-1 group flex items-center gap-px">
                            <div className="w-[2.172rem] h-[2.172rem] flex items-center transition-colors justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#00ba7c1a] rounded-full group-hover:text-[#00ba7c]">
                                <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            ...
                            <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#00ba7c]">{formatter(post.stats.repost)}</span>
                        </div>
                        <div className="flex-1 group flex items-center gap-px">
                            <div className="w-[2.172rem] h-[2.172rem] flex items-center transition-colors justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#f918801a] rounded-full group-hover:text-[#f91880]">
                                <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            ...
                            <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#f91880]">{formatter(post.stats.like)}</span>
                        </div>
                        <div className="flex-1 group flex items-center gap-px">
                            <div className="w-[2.172rem] h-[2.172rem] flex items-center transition-colors justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#1d9bf01a] rounded-full group-hover:text-[#1d9bf0]">
                                <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                            ...
                            <span className="text-[0.813rem] transition-colors text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0]">{formatter(post.stats.view)}</span>
                        </div>
