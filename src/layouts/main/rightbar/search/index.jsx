...
export default function Search(){
    ...
    return(
        <div ref={ref} className="min-h-[32px] h-[53px] mb-3 flex items-center sticky top-0 bg-[color:var(--background-primary)] z-10">
            ...
            {focus && (
                <div className="absolute top-full w-[350px] min-h-[100px] -left-px -translate-y-1 bg-[color:var(--background-primary)] rounded-lg shadow-box max-h-[calc(80vh-53px)] text-center">
                    <p className="p-3 pt-5 text-[color:var(--color-base-secondary)] leading-5">Kişileri, listeleri veya anahtar kelimeleri aramayı dene</p>
                </div>
            )}
        </div>
    )
