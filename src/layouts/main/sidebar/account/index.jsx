    ...
    return (
        <div className="mt-auto">
            <Popover className="relative">
                <Popover.Button
                    className="my-3 p-3 rounded-full hover:bg-[color:var(--background-third)] w-full flex outline-none text-left items-center outline-none transition-colors"
                >
                    ...
                    <svg viewBox="0 0 24 24" className="ml-auto w-[1.172rem] h-[1.172rem]">
                ...
                >
                    <Popover.Panel className="absolute bottom-[80px] left-1/2 w-[300px] py-3 -translate-y-2 -translate-x-1/2 bg-[color:var(--background-primary)] shadow-box rounded-2xl overflow-hidden">
                        {({ close }) => (
                            <More close={close} />
                        )}
                    </Popover.Panel>
