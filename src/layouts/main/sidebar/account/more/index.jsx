    ...
    const accounts = useAccounts()
     ...
     return (
         <div className="">
             {accounts.map(account => (
                 <button
                     ...
                     {currentAccount.id === account.id && (
                         <svg viewBox="0 0 24 24" className="mr-2 ml-3 w-[1.172rem] h-[1.172rem]">
             ...
             <button className="py-3 px-4 text-left font-bold transition-colors hover:bg-[color:var(--background-secondary)] w-full leading-[1.25rem]">Var olan bir hesap ekle</button>
             <button className="py-3 px-4 text-left font-bold transition-colors hover:bg-[color:var(--background-secondary)] w-full leading-[1.25rem]">Hesapları yönet</button>
             <button className="py-3 px-4 text-left font-bold transition-colors hover:bg-[color:var(--background-secondary)] w-full leading-[1.25rem]"><div className="max-w-[228px]">@{currentAccount.username} hesabından çıkış yap</div></button>
         </div>
     )
}