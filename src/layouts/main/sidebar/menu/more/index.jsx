    ...
    return (
        <Popover className="relative">
            <Popover.Button className="py-[3px] w-full text-left group outline-none">
                <div className="p-3 rounded-full inline-flex items-center transition-colors gap-5 group-hover:bg-[color:var(--background-third)]">
            ...
            <Popover.Panel className="w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl overflow-hidden">
                <button className="px-4 h-14 w-full inline-flex items-center transition-colors gap-5 hover:bg-[color:var(--background-secondary)]">
                    <div className="w-[1.641rem] h-[1.641rem] relative">
                ...
                <div className="h-px my-0.5 bg-[color:var(--background-third)] w-[90%] mx-auto" />
                <Disclosure>
                    {({open}) => (
                        <>
                            <Disclosure.Button className="flex items-center justify-between w-full p-4 font-bold transition-colors hover:bg-[color:var(--background-secondary)]">
                                İçerik Üreticisi Stüdyosu
                                <svg className={classNames('h-[1.172rem] transition-all duration-100', {
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="flex items-center px-3 h-11 gap-3 font-medium transition-colors hover:bg-[#eff3f41a]">
                ...
                <Disclosure>
                    {({open}) => (
                        <>
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="flex items-center px-3 h-11 gap-3 font-medium transition-colors hover:bg-[color:var(--background-secondary)]">
                                    <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                        ...
                        <>
                            ...
                            <Disclosure.Panel>
                                ...
                                <button
                                    ...
                                    className="flex items-center px-3 h-11 gap-3 w-full font-medium transition-colors hover:bg-[color:var(--background-secondary)]">
                                    <svg viewBox="0 0 24 24" className="h-[1.172rem]">
