                    ...
                    {({open}) => (
                        <>
                            <Disclosure.Button className="h-[52px] flex items-center justify-between w-full px-4 font-bold transition-colors hover:bg-[color:var(--background-secondary)]">
                                ...
                                <svg className={classNames('transition-all duration-100', {
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium transition-colors hover:bg-[#eff3f41a]">
                ...
                <Disclosure>
                    {({open}) => (
                        <>
                            ...
                            <Disclosure.Panel>
                                <Link to="/" className="flex items-center px-3 h-11 gap-3 text-[15px] font-medium transition-colors hover:bg-[color:var(--background-secondary)]">
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
                        ...
                        <>
                            ...
                            <Disclosure.Panel>
                                ...
                                <button
                                    ...
                                    className="flex items-center px-3 h-11 gap-3 text-[15px] w-full font-medium transition-colors hover:bg-[color:var(--background-secondary)]">
                                    <svg viewBox="0 0 24 24" width={18.75} height={18.75}>
