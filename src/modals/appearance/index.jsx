...
export default function AppearanceModal({ close }){
    ...
    return(
        <div className="w-[600px]">
            <h3 className="mt-8 mb-3 font-extrabold text-center text-[1.438rem] leading-7 ">Görünümü özelleştir</h3>

            <p className="text-center text-[0.938rem] leading-5 text-[color:var(--color-base-secondary)] p-8 pt-0 mb-5">Bu ayarlar, bu tarayıcıdaki tüm X hesaplarını etkiler.</p>

            <div className="mx-8 mb-4">
                <div className="border border-[color:var(--background-third)] px-4 py-3 flex gap-3 rounded-2xl">
                    <img src="https://pbs.twimg.com/profile_images/1683899100922511378/5lY42eHs_normal.jpg" className="w-[40px] h-[40px] rounded-full object-cover" alt=""/>
                    <div className="flex-1 flex flex-col">
                        <header className="leading-5 text-[15px] mb-0.5 flex items-center">
                            <div className="font-bold flex items-center">
                                X
                                <svg viewBox="0 0 22 22" className="text-[#1d9bf0] ml-1" height={18.75}>
                        ...
                        <div className="text-[color:var(--color-base)] leading-5">
                            X'in merkezinde, tıpkı bunun gibi gönderi denen kısa mesajlar yatar. Gönderiler; fotoğraflar, videolar, bağlantılar, metinler, etiketler ve <Link to="/x" className="text-[#1d9bf0] hover:underline">@X</Link> gibi bahsetmeler içerebilir.
                        </div>
                    </div>
                </div>
                    ...
                    <section>
                        ...
                        <div className="bg-[color:var(--background-secondary)] p-4 rounded-2xl flex items-center gap-5">
                            ...
                            <div className="h-1 bg-[color:var(--color-secondary)] flex-1 rounded-full relative">
                                ...
                                <div className="flex justify-between absolute -top-3.5 w-[calc(100%+16px)] -left-[8px]">
                                    {fontSizes.map(fs => (
                                        <button
                                            type="button"
                    ...
                    <section>
                        ...
                        <div className="py-2 px-4 mb-3 gap-2 grid grid-cols-3 bg-[color:var(--background-secondary)] rounded-2xl">
                            <button
                                ...
                                className={classNames("h-[62px] pr-3 pl-2 bg-white text-[#0f1419] border border-black/5 font-bold rounded group flex gap-1.5 items-center", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name === "light"
                                })}>
                                <div className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-[#71767b]/10 flex items-center justify-center">
                                ...
                                <div className="truncate flex-1 text-center pr-4">Varsayılan</div>
                            </button>
                            <button
                                onClick={() => {
                                    setColor({
                                    ...
                                    setBoxShadow('rgba(255,255,255,0.2) 0 0 15px, rgba(255, 255, 255, 0.15) 0 0 3px 1px')
                                }}
                                className={classNames("h-[62px] pr-3 pl-2 bg-[#15202b] text-[#f7f9f9] border border-white/10 font-bold rounded group flex gap-1.5 items-center", {
                                    "!border-[color:var(--color-primary)] !border-2": backgroundColor.name === "loess"
                                })}>
                                <div className="w-[40px] h-[40px] rounded-full flex-shrink-0 group-hover:bg-white/5 flex items-center justify-center">
                                    <div className={classNames("w-[20px] h-[20px] rounded-full border-[2px] border-[#5c6e7e] flex items-center justify-center", {
                                        "!border-[color:var(--color-primary)] !bg-[color:var(--color-primary)] !text-white": backgroundColor.name === "loess"
                                    })}>
                                        {backgroundColor.name === "loess" && (
                                            <svg viewBox="0 0 24 24">
                                                <path fill="currentColor" d="M9.64 18.952l-5.55-4.861 1.317-1.504 3.951 3.459 8.459-10.948L19.4 6.32 9.64 18.952z"/>
                                            </svg>
                                        )}
                                ...
                                <div className="truncate flex-1 text-center pr-4">Loş</div>
                            </button>
                            <button
                                onClick={() => {
                                    setColor({
                                ...
                                className={classNames("h-[62px] pr-3 pl-2 bg-black text-[#e7e9ea] border border-white/10 font-bold rounded group flex gap-1.5 items-center", {
                                ...
                                <div className="truncate flex-1 text-center pr-4">Işıklar kapalı</div>
                            </button>
                        </div>
                    </section>
                </div>
